...
public class LL {
    ...
    // linkedlist revese II
    public Node reverseBetween(Node head, int left, int right) {
        if (left == right) return head;

        // Move current to the left-th node
        Node current = head;
        Node prev = null;
        ...
        Node last = prev; // The node just before the reversal starts
        Node newEnd = current; // The left-th node, which will become the end after reversal
        Node next = null;
        ...
        if (last != null) {
            ...
            head = prev; // If the reversal started at the head
        }

        newEnd.next = current; // Connect the remaining part of the list
